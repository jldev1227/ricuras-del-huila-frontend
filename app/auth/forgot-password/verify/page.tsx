        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="mb-6">
            <h1 className="text-4xl sm:text-5xl font-black text-foreground-700 leading-[40px] sm:leading-[55px] sm:w-[30rem]">
              Verificación de <span className="text-primary">Código</span>
            </h1>
            <p className="text-sm text-gray-600 mt-4">
              Hemos enviado un código de seguridad a tu correo registrado.
              Escríbelo para crear una nueva contraseña.
            </p>
          </div>
