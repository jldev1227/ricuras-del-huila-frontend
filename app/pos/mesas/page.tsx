...
import { Search, Filter, X, Users, MapPin, Plus, Edit, Trash2 } from 'lucide-react'
...
export default function MesasPage() {
  ...
  const tieneFiltrosActivos = searchNumero || selectedSucursal || selectedUbicacion || selectedDisponible
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
            <div>
              <h1 className="text-3xl font-bold text-gray-900 mb-1">Gestión de Mesas</h1>
          ...
          <div className="flex items-center justify-between mb-6">
            <div>
              <h2 className="text-xl font-semibold text-gray-900">
                {loading ? 'Cargando...' : `${mesas.length} mesa${mesas.length !== 1 ? 's' : ''} encontrada${mesas.length !== 1 ? 's' : ''}`}
              </h2>
              ...
              {mesas.map((mesa) => (
                ...
                >
                  ...
                  <div className="flex items-start justify-between mb-4">
                    ...
                    <span className={`px-3 py-1 rounded-full text-xs font-semibold ${getEstadoBadge(mesa.disponible)}`}>
                    ...
                    {mesa._count.ordenes > 0 && (
                      <div className="flex items-center gap-2 text-sm">
                        ...
                        <span className="text-blue-600 font-medium">
                          {mesa._count.ordenes} orden{mesa._count.ordenes !== 1 ? 'es' : ''} activa{mesa._count.ordenes !== 1 ? 's' : ''}
                        </span>
                      </div>
                    )}
                  </div>
