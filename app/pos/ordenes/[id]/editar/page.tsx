          ...
          <div className="px-4 lg:px-6 py-4">
            ...
            <div className="relative mb-4">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-wine/20 focus:border-wine transition-all text-black"
              />
              {searchTerm && (
                <button
                  type="button"
