...
const MesaIlustracion = ({ numero, estado, onClick, isSelected }: MesaIlustracionProps) => {
...
export default function ModalSeleccionarMesa({ mesaSeleccionada, onSelectMesa }: ModalSeleccionarMesaProps) {
