...
export default function ModalFormProducto({ isOpen, onOpenChange, producto, onSuccess }: ModalFormProductoProps) {
                        ...
                        <ModalBody>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        onChange={(e) => handleChange('costoProduccion', parseFloat(e.target.value) || 0)}
                                        required
                                        min="0"
                                        step="100"
                                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent"
                            ...
                            {formData.precio > 0 && formData.costoProduccion > 0 && (
                                <div className="mt-4 p-4 bg-green-50 border border-green-200 rounded-lg">
                                    <h4 className="font-semibold text-green-800 mb-2">Análisis de ganancia</h4>
                                    <div className="grid grid-cols-2 gap-2 text-sm">
                                        <div>
                                            <span className="text-gray-600">Ganancia por unidad:</span>
                                            <p className="font-bold text-green-700">
                                                ${(formData.precio - formData.costoProduccion).toLocaleString()}
                                            </p>
                                        </div>
                                        <div>
                                            <span className="text-gray-600">Margen:</span>
                                            <p className="font-bold text-green-700">
                                                {((formData.precio - formData.costoProduccion) / formData.precio * 100).toFixed(1)}%
                                            </p>
                                        </div>
                                    </div>
                                </div>
